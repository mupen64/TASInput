...
/******************************************************************
  Function: DllAbout
  Purpose:  This optional function is provided
...
/******************************************************************
  Function: SetKeys
  Purpose:  This optional function allows the emulator to
            inform the input plugin of an internal change to the
            current state of the controllers buttons.
  input:    - Controller Number (0 to 3)
